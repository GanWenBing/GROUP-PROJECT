...
const Team = () => {
    return (
        <>
            ...
            <h1 class="flex flex-row justify-center font-medium leading-tight text-7xl mt-0 mb-2 text-blue-600 py-10">Meet the team!</h1>

            <div className="flex flex-row justify-center justify-evenly py-10">
